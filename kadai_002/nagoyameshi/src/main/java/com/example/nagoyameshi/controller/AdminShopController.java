...
public class AdminShopController {
    ...
    public String register(Model model, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
    	...
    	model.addAttribute("holidays", generateHolidayOptions());
    ...
    public String delete(@PathVariable(name = "id") Integer id, RedirectAttributes redirectAttributes) {
        Optional<Shop> shopOpt = shopService.findShopById(id);
        if (shopOpt.isPresent()) {
            shopService.delete(shopOpt.get());
            redirectAttributes.addFlashAttribute("successMessage", "店舗を削除しました。");
        } else {
            redirectAttributes.addFlashAttribute("errorMessage", "店舗が見つかりませんでした。");
        }
    ...
    public List<String> generateHolidayOptions() {
        return List.of("日曜日", "月曜日", "火曜日", "水曜日", "木曜日", "金曜日", "土曜日", "祝祭日", "定休日なし");
    }
